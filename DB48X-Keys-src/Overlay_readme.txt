...
Two SVG files are provided -- one is for MacOS and the other is for Windows.  There seems to be some discrepancy in how each platform
handles fonts, so they render differently if the same SVG is used cross-platform.
...
Premade PNG files are available in this repo and were created grom the MAC version of the SVG file.  These are named with the date appended to 
...
DB48X_tabbed_overlay_080423.png:
Dims:  72.46mm W x 89.069mm H

DB48X_overlay_080423.png:
Dims: 70.083mm W x 89.069mm H

DB48X_Standalone_Key_Fronts_080423.png:
Dims: 21.75mm W x 59.75mm H
