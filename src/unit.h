...
COMMAND_DECLARE_INSERT(ConvertToUnitPrefix);
FUNCTION(UVal);
COMMAND_DECLARE(ToUnit);
COMMAND_DECLARE_INSERT(ApplyUnit);
COMMAND_DECLARE_INSERT(ConvertToUnit);
COMMAND_DECLARE_INSERT(ApplyInverseUnit);

COMMAND_DECLARE(ToDegrees);
COMMAND_DECLARE(ToRadians);
COMMAND_DECLARE(ToGrads);
COMMAND_DECLARE(ToPiRadians);
